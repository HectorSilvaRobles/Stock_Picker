...
export default class Display extends Component{
    ...
    render(){
        const {logo, companyName, symbol, latestTime, realtimePrice, addToPortfolioFn} = this.props
        console.log(addToPortfolioFn)
        return(
            <div className='cards'>
                ...
                <div>
                    ...
                    <button onClick={() => addToPortfolioFn(logo)}>Add</button>
